...
class UserTestCase(TestCase):
    ...
    def test_add_product_to_favorites(self):
        ...
        Aliment.objects.create(product_name=product_name, pnns_groups_1=category,
                               url=url, nutriscore="e", img_url=img_url)
    ...
    def test_add_two_times_product_to_favorites(self):
        ...
        aliment = Aliment.objects.create(product_name=product_name,
                                         pnns_groups_1=category,
                                         url=url, nutriscore="e",
                                         img_url=img_url)
    ...
    def test_add_product_to_favorites_offline(self):
        ...
        Aliment.objects.create(product_name=product_name,
                               pnns_groups_1=category, url=url,
                               nutriscore="e", img_url=img_url)
